...
public class App {
        ...
        public static void main(String[] args) throws Exception {
                ...
                System.out
                                .println(String.format("\tEl numero romano %s es igual a %d en decimal.", romanNumber,
                                                decimalNumber));
                ...
                System.out
                                .println(String.format("\tEl número de dias entre %s - %s es igual a %d.", date1, date2,
                                                daysBetween));
                ...
                System.out.println(String.format("\tÁrea cuadrado: %f \t Perimetro cuadrado: %f", square.getArea(),
                                square.getPerimeter()));
                System.out.println(
                                String.format("\tÁrea rectángulo: %f \t Perimetro rectángulo: %f", rectangle.getArea(),
                                                rectangle.getPerimeter()));
                System.out.println(String.format("\tÁrea triángulo: %f \t Perimetro triángulo: %s", triangle.getArea(),
                                "WIP"));
                System.out.println(
                                String.format("\tÁrea círculo: %f \t Perimetro círculo: %f", circle.getArea(),
                                                circle.getPerimeter()));
                ...
                System.out.println("\n- - - Ejercicio 5 - - -");
                /*
                 * Crear una calculadora que nos permita:
                 * 
                 * - Coger uno o dos operandos y efectuar la operación necesaria
                 * - Es necesario controlar divisiones por cero y otros posibles problemas
                 * - Implementar operaciones suma/resta/división y multiplicación
                 * - La operación se tiene que hacer a través del método “operate”
                 * 
                 * Cada producto tiene que tener su precio y nombre
                 * 
                 */
                ...
                Add operation1 = new Add(a, b);
                Subtract operation2 = new Subtract(a, b);
                Multiplicate operation3 = new Multiplicate(a, b);
                Divide operation4 = new Divide(a, b);
                Pow operation5 = new Pow(a,  b);
                Factorial operation6 = new Factorial(a);

                System.out.println("Resultados calculadora: ");
                System.out.println(String.format("\t(Suma) %f + %f = %f", a, b, myCalculator.operate(operation1)));
                System.out.println(String.format("\t(Resta) %f - %f = %f", a, b, myCalculator.operate(operation2)));
                System.out.println(String.format("\t(Multiplicación) %f * %f = %f", a, b, myCalculator.operate(operation3)));
                System.out.println(String.format("\t(División) %f / %f = %f", a, b, myCalculator.operate(operation4)));
                System.out.println(String.format("\t(Potencia) %f ^ %f = %f", a, b, myCalculator.operate(operation5)));
                System.out.println(String.format("\t(Factorial) %f! = %.0f", a, myCalculator.operate(operation6)));
                ...
                System.out.println(
                                "Hora en España: " + spainCalendar.get(Calendar.HOUR) + ":"
                                                + spainCalendar.get(Calendar.MINUTE));
